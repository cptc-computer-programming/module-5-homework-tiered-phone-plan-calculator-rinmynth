...
elif data_used > TIER_2_DATA_LIMIT_GB and data_used <= TIER_3_DATA_LIMIT_GB:
    if has_premium:
        print("\nyou are " + str(overage_gb_tier_2) + " GB over your limit (Premium tier 2)")  
        print("overage rate: $" + str(PREMIUM_USER_OVERAGE_RATE_TIER_2) + " per GB")     
...
# tier 2 overage cost for non premium
        ...
        print("overage rate: $" + str(REGULAR_USER_OVERAGE_RATE_TIER_2 ) + " per GB")   
        print("overage cost: $" + str(Tier_2_over_cost))
        print("total bill: $" + str(total_cost_over_tier_2))    

# tier 3 overage cost for premium
elif data_used > TIER_3_DATA_LIMIT_GB:       
    if has_premium:
         print("\nyou are " + str(overage_gb_tier_3) + " GB over your limit (Premium tier 3)")    
         print("overage rate: $" + str(PREMIUM_USER_OVERAGE_RATE_TIER_3) + " per GB")   
         print("overage cost: $" + str(Tier_3_premium_over_cost) + " per GB")
         print("total bill: $" + str(total_premium_cost_over_tier_3))
# tier 3 overage cost for non premium 
    else:
        print("\nyou are " + str(overage_gb_tier_3) + " GB over your limit (Regular tier 3)")       
        print("overage rate: $" + str(REGULAR_USER_OVERAGE_RATE_TIER_3 ) + " per GB")
